...
const NAV = [
  { to: "/a/dashboard", label: "Dashboard", icon: <DashboardIcon /> },
  { to: "/a/users", label: "Users", icon: <People /> },
  { to: "/a/company-kyc", label: "Company KYC", icon: <Business /> },
  { to: "/a/jobs", label: "Job Management", icon: <Work /> },
  { to: "/a/subscription-plans", label: "Subscription Plans", icon: <CardMembership />, disabled: true },
  { to: "/a/payments", label: "Payments", icon: <Payment />, disabled: true },
  { to: "/a/support", label: "Support Tickets", icon: <SupportAgent />, disabled: true },
  { to: "/a/reports", label: "Reports", icon: <Assessment /> },
